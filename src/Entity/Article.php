...
class Article
{
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity=Comments::class, mappedBy="article", cascade={"remove"})
     */
    private $comments;
    ...
    /**
     * @ORM\OneToMany(targetEntity=PostLike::class, mappedBy="article", cascade={"remove"})
     */
    private $Likes;

    /**
     * @ORM\OneToMany(targetEntity=PostDislike::class, mappedBy="article", cascade={"remove"})
     */
    private $Dislike;
     ...
     * @param mixed $nbLikes
     */
    public function setNbLikes($nbLikes): void
    {
    ...
    /**
     * @param mixed $nbDislike
     */
    public function setNbDislike($nbDislike): void
    {
