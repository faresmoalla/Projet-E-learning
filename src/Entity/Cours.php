...
class Cours
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Questionn::class, mappedBy="cours")
     */
    private $Questionn;
    ...
    public function __construct()
    {
        ...
        $this->questionns = new ArrayCollection();
    }
    public function ___construct()
    {
        $this->Questionn = new ArrayCollection();
    }
    ...
    /**
     * @return Collection|Questionn[]
     */
    public function getQuestionn(): Collection
    {
        return $this->Questionn;
    }

    public function addQuestionn(Questionn $questionn): self
    {
        if (!$this->Questionn->contains($questionn)) {
            $this->Questionn[] = $questionn;
            $questionn->setCours($this);
        }

        return $this;
    }

    public function removeQuestionn(Questionn $questionn): self
    {
        if ($this->Questionn->removeElement($questionn)) {
            // set the owning side to null (unless already changed)
            if ($questionn->getCours() === $this) {
                $questionn->setCours(null);
            }
        }
     ...
     * @return Collection|Questionn[]
     */
    public function getQuestionns(): Collection
    {
        return $this->questionns;
    }
