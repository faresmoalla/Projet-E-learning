...
@FXML
    private void supprimerAdmin(ActionEvent event) throws SQLException {
         if (event.getSource()==zd_suppa) {
            Admin m = new Admin();
            m.setId(zd_tableAdmin.getSelectionModel().getSelectedItem().getId());
            System.out.println(zd_tableAdmin.getSelectionModel().getSelectedItem().getId());
;
        AdminService as = new AdminService();
        as.supprimerAdmin(m);
                     resetTableData();
    ...
    private void mofiierAdmin(ActionEvent event) {
        ...
        int id = zd_tableAdmin.getSelectionModel().getSelectedItem().getId();
