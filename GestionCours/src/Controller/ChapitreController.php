...
class ChapitreController extends AbstractController
{
    ...
    /**
     * @Route("/qrcodechapitre/{id}", name="qrcodechapitre")
     * @param Request $request
     * @param QrcodeService $qrcodeService
     * @return Response
     */
    public function qrcode($id,Request $request, QrcodeService $qrcodeService,ChapitreRepository $repository): Response
    {
        $chapitre=$repository->find($id)->getChapitrenom();

        $qrCode = null;
        $qrCode = $qrcodeService->qrcode($chapitre);

        return $this->render('chapitre/qrcodechapitre.html.twig', [
            'qrCode2' => $qrCode
        ]);
